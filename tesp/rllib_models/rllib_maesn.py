...
class RLlibMAESN(MAMLModel):
    ...
    def loss(self):
        reg_loss = tf.reduce_mean(tf.square(self.policy_model.state))
        return reg_loss
    ...
    def prepare(policy_graph, options):
        ...
        with tf.name_scope("variables"):
            ...
            variables["policy"] = KerasMAESN.get_variables(
